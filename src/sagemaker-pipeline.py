...
def create_pipeline():
    ...
    train_data_path = (
        "s3://srushanth-baride/binary-classification-with-a-bank-dataset/train.csv"
    )
    test_data_path = (
        "s3://srushanth-baride/binary-classification-with-a-bank-dataset/test.csv"
    )
    ...
    # Split data
    step_split_train_data = split_data(
        step_preprocess_train_data[0], step_preprocess_train_data[1]
    )
    ...
    # Make predictions
    step_predict = make_predictions(step_train, step_preprocess_test_data)
